...
// Button btnOK;
// EditText txtTenkh, txtDiachilapdat, txtTennguoilh, txtDiachilh, txtSodtlh,
// txtEmail, txtThoigianlh, txtNguoigt,
// txtFonegt, txtGhichu;
//
// @Override
...
// tiepnhanDVVTTask.input.add(((LoaiDichVu)
// spnLoaiDichVu.getSelectedItem()).getID());
...
// tiepnhanDVVTTask.input.add(((PhuongXa)
// spnPhuongXa.getSelectedItem()).getID());
...
// SoapObject lstResult = (SoapObject) ((SoapObject)
// csOnlineGetLoaiDichVuTask.result).getProperty("Result");
// lstLoaiDichVu = Util.SetDataToSpinner(context, spnLoaiDichVu, lstResult,
// LoaiDichVu.class, false, "Ten");
// lstResult = (SoapObject) ((SoapObject)
// getQuanHuyenTask.result).getProperty("Result");
// lstQuanHuyen = Util.SetDataToSpinner(context, spnQuanHuyen, lstResult,
// QuanHuyen.class, false, "Ten");
//
// }
// if (ws.equals(phuongxaTask)) {
// SoapObject lstResult = (SoapObject) ((SoapObject)
// phuongxaTask.result).getProperty("Result");
// Util.SetDataToSpinner(context, spnPhuongXa, lstResult, PhuongXa.class, false,
// "Ten");
//
// }
// if (ws.equals(loaiYeuCauTask)) {
// SoapObject lstResult = (SoapObject) ((SoapObject)
// loaiYeuCauTask.result).getProperty("Result");
// Util.SetDataToSpinner(context, spnLoaiYeuCau, lstResult, PhuongXa.class,
// false, "Ten");
//
// }
// if (ws instanceof TiepnhanDVVTTask) {
// try {
// String mess = ((SoapObject)
// tiepnhanDVVTTask.result).getPropertyAsString("Message");
//
