...
// String res = ((SoapObject)
// checkUserTask.result).getPropertyAsString("Result");
// if (res.toLowerCase().equals("true")) {
// Intent i = new Intent(context, CSOActivity.class);
// startActivity(i);
// } else {
// Util.showAlert(context, "Để sử dụng chương trình cần đăng nhập với user XTTT
// Hà Nội ở lần đầu tiên");
