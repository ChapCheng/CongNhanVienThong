...
// import control.Util;
//
// public class ActivityMap extends ActivityBaseToDisplay implements
...
// circle = map.addCircle(new
// CircleOptions().center(me).radius(500).strokeWidth(1));
// }
//
...
// MarkerOptions().draggable(true).anchor(0.5f, 1.0f).title("me");
...
// map.addMarker(new MarkerOptions().draggable(true).anchor(0.5f,
// 1.0f).position(BTS).title("BTS"));
...
// "Cập nhật bản mới nhất các tiện ích google trên máy để dùng chức năng bản
// đồ");
//
// }
//
...
// LatLng tempLatLng =
// Util.DoiLongLat(Double.valueOf(devive.getPropertyAsString("Latitude")),
...
// Device temp = new Device(devive.getPropertyAsString("DeviceName"),
// tempLatLng,
...
// BitmapDescriptor iconOther =
// BitmapDescriptorFactory.fromResource(R.drawable.bts_icon_grey);
// BitmapDescriptor iconVNP =
// BitmapDescriptorFactory.fromResource(R.drawable.bts_icon_green);
// mko.title(Util.GetNameDevice(devices, toado));
// BitmapDescriptor currentBTS =
// BitmapDescriptorFactory.fromResource(R.drawable.bts_icon_red);
//
...
// // TODO: handle exception
// e.printStackTrace();
// Toast.makeText(ActivityMap.this, "Không có kết quả tìm kiếm",
