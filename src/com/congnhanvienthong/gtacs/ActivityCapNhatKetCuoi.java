...
// } catch (Exception e) {
// // TODO: handle exception
// Toast t = Toast.makeText(context, "Bạn không có quyền cập nhật các kết
// cuối.", Toast.LENGTH_LONG);
...
// if (length == 0) {
// Toast t = Toast.makeText(context, "Bạn không có quyền cập nhật ở các vệ
// tinh.", Toast.LENGTH_LONG);
// t.setGravity(Gravity.CENTER, 0, 0);
// t.show();
// return;
// }
...
// spinnerLoaiTuchua.setOnItemSelectedListener(new
...
// }
//
// adapter = new BaseSpinnerAdapter<LoaiDoiTuong>(context,
...
//
// spinnerLoaiDoiTuong.setOnItemSelectedListener(new
// AdapterView.OnItemSelectedListener() {
//
// public void onItemSelected(AdapterView<?> arg0, View arg1, int arg2, long
// arg3) {
...
// if (sttSpliptter.getVisibility() == View.GONE) {
//
// madoituong = maLoaiDoiTuong + "-" + maVeTinh + "/" +
// maDichVu.getText().toString();
// }
// if (sttSpliptter.getVisibility() == View.VISIBLE) {
// // maDT = tienTo +
...
// "Có sự thay đổi về đối tượng cần cập nhật. Cần kiểm tra lại trước khi cập
// nhật!",
// Toast.LENGTH_LONG);
...
//
// }
// Util.showAlert(context, "Có " + length + " mã dịch vụ sau gần giống mã bạn
// vừa gõ :" + danhSachMa);
// }
//
// } catch (Exception e) {
...
// if (tonTai.equals("0")) {
// Toast toast = Toast.makeText(context,
// "Mã chưa có trong dữ liệu về vị trí. \nNgười dùng có thể thực hiện cập nhật
// ngay bây giờ",
// Toast.LENGTH_LONG);
// toast.setGravity(Gravity.CENTER, 0, 0);
// toast.show();
...
// ok = false;
// }
// if (maDichVu.getText().length() == 0 && maDichVu.getVisibility() ==
// View.VISIBLE) {
...
// // }
//
// if (sttSpliptter.getText().toString().length() == 0 &&
// sttSpliptter.getVisibility() == View.VISIBLE) {
